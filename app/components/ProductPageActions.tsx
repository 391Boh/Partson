    ...
    >
      ...
      {hasPrice ? (
        <div className={`grid gap-2.5 ${compact ? "grid-cols-[minmax(0,1fr)_auto]" : "grid-cols-[minmax(0,1fr)_auto]"}`}>
          <div className="inline-flex min-w-0 items-center justify-between rounded-2xl border border-slate-200 bg-white/90 p-1 shadow-sm">
            <button
              type="button"
          ...
          <button
            ...
            className={`inline-flex h-12 min-w-[148px] shrink-0 items-center justify-center gap-2 rounded-2xl px-4 text-sm font-bold text-white transition ${
              justAdded
        ...
        <button
          ...
          className="inline-flex h-12 min-w-[168px] items-center justify-center gap-2 rounded-2xl bg-red-600 px-4 text-sm font-bold text-white shadow-[0_14px_28px_rgba(220,38,38,0.24)] transition hover:bg-red-500"
        >
