...
export const carBrands: CarBrand[] = [
  ...
  { id: 10, name: "DODGE", logo: "/Carlogo/optimized/Dodge.webp" },
  { id: 11, name: "FERRARI", logo: "/Carlogo/Ferrari.svg" },
  { id: 12, name: "FIAT", logo: "/Carlogo/optimized/Fiat.webp" },
  ...
  { id: 18, name: "HYUNDAI", logo: "/Carlogo/optimized/Hyunndai.webp" },
  ...
  { id: 26, name: "LAMBORGHINI", logo: "/Carlogo/optimized/Lamborghini.webp" },
  { id: 27, name: "LANCIA", logo: "/Carlogo/Lancia.svg" },
  { id: 28, name: "LAND ROVER", logo: "/Carlogo/optimized/Landrover.webp" },
  ...
  { id: 34, name: "MAYBACH", logo: "/Carlogo/optimized/Maybach.webp" },
  { id: 35, name: "MAZDA", logo: "/Carlogo/mazda.png" },
  { id: 36, name: "MERCEDES-BENZ", logo: "/Carlogo/optimized/Mercedes.webp" },
  ...
  { id: 43, name: "PORSCHE", logo: "/Carlogo/optimized/Porsche.webp" },
  ...
  { id: 49, name: "SEAT", logo: "/Carlogo/optimized/Seat.webp" },
  ...
  { id: 53, name: "SUBARU", logo: "/Carlogo/optimized/Subaru.webp" },
  ...
  { id: 60, name: "ALFA ROMEO", logo: "/Carlogo/optimized/Alfaromeo.webp" },
  { id: 61, name: "ASTON MARTIN", logo: "/Carlogo/optimized/Astonmartin.webp" },
  { id: 62, name: "BENTLEY", logo: "/Carlogo/optimized/Bentley.webp" },
];
