...
export const metadata: Metadata = {
  ...
  description:
    "Магазин автозапчастин у Львові PartsON (вул. Перфецького, 8): каталог деталей з актуальною наявністю, цінами та швидким підбором за кодом, артикулом і виробником.",
  ...
  openGraph: {
    ...
    description:
      "Автозапчастини у Львові: PartsON на вул. Перфецького, 8. Швидкий підбір деталей і доставка по Львову та Україні.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "PartsON - Магазин автозапчастин",
    description:
      "Магазин автозапчастин у Львові з підбором за кодом і доставкою по Львову та Україні.",
  ...
  return (
    <html lang="uk">
      <head>
        ...
        <link
          rel="preload"
          href="/fonts/exo2-variable-italic.ttf"
          as="font"
          type="font/ttf"
          crossOrigin="anonymous"
        />
