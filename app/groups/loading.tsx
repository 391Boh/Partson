  ...
  return (
    ...
    >
      ...
      <div className="page-shell-inline py-3 sm:py-4 lg:py-5">
        <section className="overflow-hidden rounded-[28px] border border-white/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.98),rgba(240,249,255,0.92),rgba(240,253,250,0.88))] p-5 shadow-[0_20px_44px_rgba(14,165,233,0.1)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl space-y-3">
              <div className="skeleton-item h-5 w-24 rounded-full bg-teal-100/90" />
              <div className="skeleton-item h-9 w-3/4 max-w-[360px] rounded-2xl bg-slate-200/80" />
            ...
            <div className="flex shrink-0 flex-col gap-2 lg:items-end">
              <div className="skeleton-item h-8 w-32 rounded-xl bg-teal-100/70" />
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="skeleton-item h-12 w-12 shrink-0 rounded-[14px] bg-teal-100/80" />
                  <div className="min-w-0 flex-1">
                    <div className="skeleton-item h-5 w-3/5 rounded-full bg-slate-200/80" />
                    <div className="skeleton-item mt-2 h-3.5 w-4/5 rounded-full bg-slate-200/60" />
                    <div className="skeleton-item mt-1 h-3.5 w-2/3 rounded-full bg-slate-200/50" />
                  </div>
                </div>
              </div>
            ))}
