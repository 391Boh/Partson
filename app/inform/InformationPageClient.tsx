  ...
  return (
    ...
    >
      ...
      <section className="page-shell-inline relative grid gap-4 py-4 sm:py-6">
        ...
        <div className="rounded-3xl border border-white/10 bg-slate-900/55 px-4 py-4 shadow-[0_16px_40px_rgba(2,6,23,0.3)] backdrop-blur-xl sm:px-5 sm:py-5">
          <h1 className="font-display-italic text-[1.6rem] leading-[0.98] tracking-[-0.05em] text-white sm:text-[1.95rem]">
            {activeTab.seoTitle}
          </h1>
