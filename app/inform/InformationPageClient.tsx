...
const UKRAINE_MAPS_EMBED_URL = 'https://www.google.com/maps?q=Ukraine&output=embed';
    ...
    <div className="sm:col-span-2">
      <InfoCard title="Доставка автозапчастин у Львові та в кожне місто України" icon={Route} accent="sky" featured>
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.05fr)_minmax(260px,0.95fr)] lg:items-start">
          ...
          <div className="overflow-hidden rounded-2xl border border-sky-100 shadow-[0_12px_26px_rgba(14,165,233,0.08)]">
            <p className="bg-[linear-gradient(145deg,rgba(255,255,255,0.95),rgba(240,249,255,0.9))] px-3 py-2 text-[11px] font-black uppercase tracking-[0.12em] text-sky-700">
              Географія доставки
            </p>
            <iframe
              title="PartsON — Карта доставки по Україні"
              src={UKRAINE_MAPS_EMBED_URL}
              className="h-[280px] w-full border-0"
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
            />
            <p className="sr-only">
              PartsON доставляє автозапчастини по всій Україні, зокрема у Київ, Харків,
              Одесу, Дніпро, Запоріжжя, Львів та інші міста.
            </p>
          </div>
        </div>
      </InfoCard>
