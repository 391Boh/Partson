...
export const informationSections: InformationSection[] = [
  {
    ...
    seoTitle: "Доставка автозапчастин Новою Поштою: Львів, Київ, Харків, Одеса",
    seoDescription: appendSeoContact(
      "Доставка автозапчастин PartsON Новою Поштою в Київ, Харків, Одесу, Дніпро та кожне місто України, а також оперативна доставка і самовивіз у Львові."
    ),
    keywords: [
