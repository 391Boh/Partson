...
export const informationSections: InformationSection[] = [
  ...
  },
  {
    ...
    seoDescription:
      "Комп'ютерна діагностика авто у Львові в PartsON: OBD-II/EOBD, Check Engine, ECU, ABS, ESP, SRS, АКПП, розшифрування помилок, перевірка перед купівлею та підбір запчастин. Адреса: вул. Перфецького, 8, тел. +38 (093) 480-42-61.",
    keywords: [
